                    ...
                    public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                        if (task.isSuccessful()) {
                            ...
                            if (user != null) {
                                ...
                                ConstraintLayout layout2 = (ConstraintLayout) findViewById(R.id.layout_connexion);
                                Button bouton = (Button) findViewById(R.id.s_inscrire_bouton);
                                ImageView logo = (ImageView) findViewById(R.id.logo);
                                layout2.removeView(bouton);
                                layout2.removeView(logo);
                                ProgressBar progressBar = new ProgressBar(context, null, android.R.attr.progressBarStyleLarge);
                                progressBar.setVisibility(View.VISIBLE);
                                ...
                                AuthUI.getInstance()
                                        ...
                                        .addOnCompleteListener(new OnCompleteListener<Void>() {
                                            ...
                                            public void onComplete(@NonNull Task<Void> task) {
                                                if (task.isSuccessful()) {
                                                    // Deletion succeeded
                                                    Intent intent = new Intent(ConnexionPage.context, NoAccountPage.class);
                                                    startActivity(intent);
                                                } else {
                                                    // Deletion failed
                                                }
